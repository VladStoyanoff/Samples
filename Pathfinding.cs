...
public class Pathfinding : MonoBehaviour
{
    ...
    // Sets up a tile-based grid system
    ...
    // Finds the path from the starting grid position the unit is in towards the ending grid position the player (or AI) has asked the unit to go
    ...
    // Makes a list with all the neighbouring nodes of the passed parameter - currentNode. This is needed when trying to figure out the node with the lowest F cost
    ...
    // Returns a list with the path nodes the unit should go through
    ...
    // Getter methods for reference in other scripts
